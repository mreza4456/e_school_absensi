...
return new class extends Migration
{
        ...
        BEGIN
            ...
            IF EXISTS (
                ...
                AND (keterangan = NEW.keterangan
                    OR (NEW.keterangan IN ('Masuk', 'Terlambat')
    ...
    private function pgsqlTrigger()
    {
        ...
        BEGIN
            ...
            -- Debug log
            RAISE NOTICE 'Input DateTime: %', input_datetime;
            RAISE NOTICE 'Input Time: %', input_datetime::TIME;
            ...
            RAISE NOTICE 'Jadwal Masuk: %', jadwal_masuk;
            RAISE NOTICE 'Jadwal Masuk Selesai: %', jadwal_masuk_selesai;
            RAISE NOTICE 'Current Time: %', input_datetime::TIME;
            ...
            ELSE
                RAISE EXCEPTION 'Waktu absensi di luar jam sekolah. Waktu: %, Jadwal: % - %',
                            input_datetime::TIME, jadwal_masuk, jadwal_masuk_selesai;
            END IF;
